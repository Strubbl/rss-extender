...
class ConfigTest extends TestCase
{
  ...
  public function testConfigContentRegexNotEmpty()
  {
      ...
      foreach($feed->testUrls as $testUrl) {
        ...
        $this->assertNotEmpty($test_url_content, "In feed " . $feed->name . " a content regex returned an empty string: " . $testUrl . " with regex " . $feed->contentRegex . "\ncontent:\n" . $this->rssExtender->getContentOfUrl($testUrl));
      }
  	}
  }
}
